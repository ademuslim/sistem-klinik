                ...
                <div class="form-group">
                    ...
                    <div>
                        <label class="radio-inline">
                            <input type="radio" name="penatalaksanaan" id="penatalaksanaan" value="Terapi Alternatif" required> Terapi Alternatif
                        </label>

                        <label class="radio-inline">
                            <input type="radio" name="penatalaksanaan" value="Terapi Kausatif" required> Terapi Kausatif
                        </label>
                    </div>
                </div>
